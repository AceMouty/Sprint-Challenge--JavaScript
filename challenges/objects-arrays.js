...
*/
const animalNames = zooAnimals.map(({animal_name, scientific_name}) => `Name: ${animal_name}, Scientific Name; ${scientific_name}`);
...
*/
const populationTotal = zooAnimals.reduce((acc, cv) => acc += cv.population, 0)
